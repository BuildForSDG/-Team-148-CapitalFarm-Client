			...
			<React.Fragment>
				<div className="">
							...
							<form className="form-inline float-sm-right mt-3 mt-sm-0">
								...
								<UncontrolledButtonDropdown>
									<DropdownToggle color="primary" className="dropdown-toggle">
										<i className="uil uil-file-alt mr-1" />Download
									...
									<DropdownMenu right>
										<DropdownItem>
											<Mail className="icon-dual icon-xs mr-2" />
											<span>Email</span>
										</DropdownItem>
										<DropdownItem>
											<Printer className="icon-dual icon-xs mr-2" />
											<span>Print</span>
										</DropdownItem>
										<DropdownItem divider />
										<DropdownItem>
											<File className="icon-dual icon-xs mr-2" />
					...
					<Row>
						...
						<Col xl={6}>{/* <RevenueChart /> */}</Col>
						<Col xl={3}>{/* <TargetChart /> */}</Col>
					</Row>

					{/* charts */}
					<Row>
						<Col xl={5}>{/* <SalesChart /> */}</Col>
						<Col xl={7}>{/* <Orders /> */}</Col>
					</Row>
